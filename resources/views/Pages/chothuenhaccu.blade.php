...
<!-- End .header -->
<main class="main">
    <img src="assets/images/ct.jpg" alt="salem piano">
    <div class="container">
        <br>
        <br>
        <div class="row">
            <div class="col-lg-9">
                <h3 class="text-center font-weight-bold">CHO THUÊ NHẠC CỤ </h3>
                <br> {!! $menu->noiDung !!}
            </div>
            <div class="col-lg-3">
...
<title>Salem Piano Cho Thuê Nhạc Cụ Tại Đà Nẵng - Bán Đàn Piano Ở Đà Nẵng - Dạy Học Piano Tại Đà Nẵng</title>
...
<meta name="og:url" content="{{ route('Pages.chothuenhaccu') }}" /> @endsection
