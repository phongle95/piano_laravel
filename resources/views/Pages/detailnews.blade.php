            ...
            <div class="row">
                <div class="col-lg-9">
                    <article class="entry single">
                        ...
                        <div class="fb-like" data-href="{{ route('Pages.detailnews',['slug'=>str_slug($chitiet->tieuDe),'id'=>$chitiet->id,'ma'=>$chitiet->maLoaiTin]) }}" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                        <br>  <br>
                        <div class="entry-body">
                            ...
                            <div class="entry-share">
                                ...
                                <div class="fb-comments" data-href="{{ route('Pages.detailnews',['slug'=>str_slug($chitiet->tieuDe),'id'=>$chitiet->id,'ma'=>$chitiet->maLoaiTin]) }}" data-numposts="5"></div>
...
<meta name="og:url" content="{{ route('Pages.detailnews',['slug'=>str_slug($chitiet->tieuDe),'id'=>$chitiet->id,'ma'=>$chitiet->maLoaiTin]) }}" />
 @endsection
