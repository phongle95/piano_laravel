...
<!-- End .header -->
<main class="main">
    <img src="assets/images/sk.jpg" alt="salem piano">
    <div class="container">
        <br>
        <br>
        <div class="row">
            <div class="col-lg-8">
                <h3 class="text-center font-weight-bold">TỔ CHỨC SỰ KIỆN </h3>
                <br> {!! $menu->noiDung !!}
            </div>
            <div class="col-lg-4">
...
<title>Salem Piano Chuyên Tổ Chức Sự kiện Tại Đà Nẵng - Bán Đàn Piano Ở Đà Nẵng - Dạy Học Piano Tại Đà Nẵng</title>
...
<meta name="description" content='Piano center , Music center Chuyên mua Bán đàn piano được nhập khẩu từ nhật bản và dạy học đàn piano ở đà nẵng và các loại nhạc cụ Salem piano nhận tổ chức sự kiện tại đà nẵng' />
<!--meta facebook-->
<meta property="og:title" content="salem piano tổ chức sự kiện - piano center - music center bán đàn piano ở đà nẵng và dạy học đàn piano tại đà nẵng" />
...
<meta name="og:url" content="{{ route('Pages.tochucsukien') }}" /> @endsection
