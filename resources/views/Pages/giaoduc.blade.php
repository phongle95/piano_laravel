...
<!-- End .header -->
<main class="main">
    <img src="assets/images/giaoduc.jpg" alt="salem piano">
    <div class="container">
        <br>
        <br>
        <div class="row">
...
<title>Music Center Nhận Dậy Học Piano ở Đà Nẵng - Bán Đàn Piano Ở Đà Nẵng - Dạy Học Piano Tại Đà Nẵng</title>
...
<meta itemprop="image" content="assets/images/dayhoc.jpg" />
<meta name="og:url" content="{{ route('Pages.giaoduc') }}" /> @endsection
