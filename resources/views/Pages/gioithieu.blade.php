...
<!-- End .header -->
<main class="main">
    <img src="assets/images/gioithieu.jpg" alt="salem piano">
    <div class="container">
        <br>
        <br>
        <div class="row">
...
<title>Giới Thiệu Về Salem Piano - Salem Piano - Piano Đà Nẵng - Guitar Đà Nẵng</title>
...
<meta name="og:url" content="{{ route('Pages.gioithieu') }}" /> @endsection
