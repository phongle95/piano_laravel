         ...
         <div class="col-md-9">
            <div class="card">
               ...
               @if ($errors->any())
                ...
                @endif
               <div class="card-body">
                  <form action="{{ route('PageAdmin.sanpham.them') }}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                        <div class="row">
                                <div class="col-md-12">
                                   <div class="form-group">
                                      <label class="bmd-label-floating" style="color:black;font-weight: 600">Tên Sản Phẩm</label>
                                      <input type="text" class="form-control" name="tenSP" value="{{ old('tenSP') }}">
                                   </div>
                                </div>
                             </div>
                             <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              <div class="form-group">
                                 ...
                                 <textarea class="form-control" rows="5" name="tomTat">{{ old('tomTat') }}</textarea>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                      ...
                      <div class="row">
                            <div class="form-group col-md-12">
                                    ...
                                    <textarea name="TSKT" class="form-control" id="editor2">{{ old('TSKT') }}</textarea>
                           </div>
                      </div>
