   ...
   <div class="col-md-12">
      ...
      <div class="card">
         ...
         <div class="card-body card-block">
            <form action="{{ route('PageAdmin1.tin.sua',$tin->id) }}"  enctype="multipart/form-data" method="POST" class="form-horizontal">
               ...
               <div class="card-footer">
                  ...
                  <a href="{{ route('PageAdmin1.tin.danhsach') }}" class="btn btn-info btn-fw">
                  Quay về
                  </a>
               </div>
            </form>
